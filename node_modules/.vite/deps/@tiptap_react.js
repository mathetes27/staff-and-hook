...
import { $ as generateText, $t as markPasteRule, A as createChainableState, At as isAndroid, B as elementFromString, Bt as isNodeActive, C as attrsEqual, Cn as textblockTypeInputRule, Ct as getTextContentFromNodes, D as commands_exports, Dt as injectExtensionAttributesToParseRule, E as combineTransactionSteps, Et as h, F as createStyleTag, Ft as isFirefox, G as findChildrenInRange, Gt as isPlainObject, H as escapeForRegEx, Ht as isNodeSelection, I as createWidgetDecoration, It as isFunction, J as findParentNodeClosestToPos, Jt as isString, K as findDuplicates, Kt as isRegExp, L as decodeHtmlEntities, Lt as isList, M as createInlineMarkdownSpec, Mt as isAtStartOfNode, N as createMappablePosition, Nt as isEmptyObject, O as createAtomBlockMarkdownSpec, Ot as inputRulesPlugin, P as createNodeFromContent, Pt as isExtensionRulesEnabled, Q as generateJSON, Qt as markInputRule, R as defaultBlockAt, Rt as isMacOS, S as WidgetDecoration, Sn as textPasteRule, St as getTextBetween, T as canInsertNode, Tn as wrappingInputRule, Tt as getUpdatedPosition, U as extensions_exports, Ut as isNodeViewSelected, V as encodeHtmlEntities, Vt as isNodeEmpty, W as findChildren, Wt as isNumber, X as fromString, Xt as isiOS, Y as flattenExtensions, Yt as isTextSelection, Z as generateHTML, Zt as liveWidgetKeys, _ as NodeView, _n as selectionToInsertionEnd, _t as getSchemaTypeByName, a as Editor, an as nodeInputRule, at as getHTMLFromFragment, b as ResizableNodeview, bn as splitExtensions, bt as getStyleProperty, c as Fragment7, cn as parseAttributes, ct as getMarkType, d as MappablePosition, dn as posToDOMRect, dt as getNodeAttributes, en as markdown_exports, et as getAttributes, f as Mark, fn as removeDuplicates, ft as getNodeType, g as NodePos, gn as rewriteUnknownContent, gt as getSchemaByResolvedExtensions, h as NodeDecoration, hn as resolveFocusPosition, ht as getSchema, i as DecorationManager, in as minMax, it as getExtensionField, j as createDocument, jt as isAtEndOfNode, k as createBlockMarkdownSpec, kt as isActive, l as InlineDecoration, ln as parseIndentedBlocks, lt as getMarksBetween, m as Node3, mn as resolveExtensions, mt as getRenderedAttributes, n as DECORATION_MANAGER_PLUGIN_KEY, nn as mergeAttributes, nt as getChangedRanges, o as Extendable, on as nodePasteRule, ot as getMarkAttributes, p as MarkView, pn as renderNestedMarkdownContent, pt as getPreviousBlockSibling, q as findParentNode, qt as isSafari, r as Decoration, rn as mergeDeep, rt as getDebugJSON, s as Extension, sn as objectIncludes, st as getMarkRange, t as CommandManager, tn as marksEqual, tt as getAttributesFromExtensions, u as InputRule, un as pasteRulesPlugin, ut as getNodeAtPosition, v as PasteRule, vn as serializeAttributes, vt as getSchemaTypeNameByName, w as callOrReturn, wn as updateMarkViewAttributes, wt as getTextSerializersFromSchema, x as Tracker, xn as textInputRule, xt as getText, y as ResizableNodeView, yn as sortExtensions, yt as getSplittedAttributes, z as deleteProps, zt as isMarkActive } from "./dist-CN5VY376.js";
	...
	*/
	watch(nextEditor) {
		...
		if (this.editor) {
			let lastTransaction;
			const fn = (props) => {
				if ((props == null ? void 0 : props.transaction) !== void 0 && props.transaction === lastTransaction) return;
...
function EditorProvider({ children, slotAfter, slotBefore, editorContainerProps = {}, ...editorOptions }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(EditorContext.Provider, {
		value: contextValue,
		children: [
			slotBefore,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EditorConsumer, { children: ({ editor: currentEditor }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EditorContent, {
...
var ReactNodeViewContentProvider = ({ children, content }) => {
	return (0, import_react.createElement)(ReactNodeViewContext.Provider, { value: { nodeViewContentChildren: content } }, children);
};
	...
	*/
	constructor(component, { editor, props = {}, as = "div", className = "" }) {
		...
		*/
		...
		if (this.editor.isEditorContentInitialized) (0, import_react_dom.flushSync)(() => {
			this.render();
		});
		else queueMicrotask(() => {
...
var ReactMarkViewContext = import_react.createContext({ markViewContentRef: () => {} });
var MarkViewContent = (props) => {
	const { as: Tag = "span", ...rest } = props;
	const { markViewContentRef } = import_react.useContext(ReactMarkViewContext);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tag, {
		...rest,
...
var ReactMarkView = class extends MarkView {
	constructor(component, props, options) {
		...
		const ReactMarkViewProvider = import_react.memo((componentProps2) => {
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReactMarkViewContext.Provider, {
				value: context,
				children: import_react.createElement(component, componentProps2)
			});
		});
...
//#endregion
export { CommandManager, DECORATION_MANAGER_PLUGIN_KEY, Decoration, DecorationManager, Editor, EditorConsumer, EditorContent, EditorContext, EditorProvider, Extendable, Extension, Fragment7 as Fragment, InlineDecoration, InputRule, MappablePosition, Mark, MarkView, MarkViewContent, Node3 as Node, NodeDecoration, NodePos, NodeView, NodeViewContent, NodeViewWrapper, PasteRule, PureEditorContent, ReactMarkView, ReactMarkViewContext, ReactMarkViewRenderer, ReactNodeView, ReactNodeViewContentProvider, ReactNodeViewContext, ReactNodeViewRenderer, ReactRenderer, ReactWidgetRenderer, ResizableNodeView, ResizableNodeview, Tiptap, TiptapContent, TiptapContext, TiptapWrapper, Tracker, WidgetDecoration, attrsEqual, callOrReturn, canInsertNode, combineTransactionSteps, commands_exports as commands, createAtomBlockMarkdownSpec, createBlockMarkdownSpec, createChainableState, createContentComponent, createDocument, h as createElement, h, createInlineMarkdownSpec, createMappablePosition, createNodeFromContent, createStyleTag, createWidgetDecoration, decodeHtmlEntities, defaultBlockAt, deleteProps, elementFromString, encodeHtmlEntities, escapeForRegEx, extensions_exports as extensions, findChildren, findChildrenInRange, findDuplicates, findParentNode, findParentNodeClosestToPos, flattenExtensions, fromString, generateHTML, generateJSON, generateText, getAttributes, getAttributesFromExtensions, getChangedRanges, getDebugJSON, getExtensionField, getHTMLFromFragment, getMarkAttributes, getMarkRange, getMarkType, getMarksBetween, getNodeAtPosition, getNodeAttributes, getNodeType, getPreviousBlockSibling, getRenderedAttributes, getSchema, getSchemaByResolvedExtensions, getSchemaTypeByName, getSchemaTypeNameByName, getSplittedAttributes, getStyleProperty, getText, getTextBetween, getTextContentFromNodes, getTextSerializersFromSchema, getUpdatedPosition, injectExtensionAttributesToParseRule, inputRulesPlugin, isActive, isAndroid, isAtEndOfNode, isAtStartOfNode, isEmptyObject, isExtensionRulesEnabled, isFirefox, isFunction, isList, isMacOS, isMarkActive, isNodeActive, isNodeEmpty, isNodeSelection, isNodeViewSelected, isNumber, isPlainObject, isRegExp, isSafari, isString, isTextSelection, isiOS, liveWidgetKeys, markInputRule, markPasteRule, markdown_exports as markdown, marksEqual, mergeAttributes, mergeDeep, minMax, nodeInputRule, nodePasteRule, objectIncludes, parseAttributes, parseIndentedBlocks, pasteRulesPlugin, posToDOMRect, removeDuplicates, renderNestedMarkdownContent, resolveExtensions, resolveFocusPosition, rewriteUnknownContent, selectionToInsertionEnd, serializeAttributes, sortExtensions, splitExtensions, textInputRule, textPasteRule, textblockTypeInputRule, updateMarkViewAttributes, useCurrentEditor, useEditor, useEditorState, useReactNodeView, useTiptap, useTiptapState, wrappingInputRule };
