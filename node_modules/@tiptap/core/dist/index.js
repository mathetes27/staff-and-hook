...
var insertContentAt = (position, value, options) => ({ tr, dispatch, editor }) => {
  ...
  if (dispatch) {
    ...
    if (isOnlyTextContent) {
      ...
      newContent = Fragment2.from(nodes);
...
function mapDecorations(name, previous, tr) {
  var _a, _b;
  const previousSet = (_a = previous.decorationSetsByExtension[name]) != null ? _a : DecorationSet2.empty;
...
function mergeDecorationSets(doc, decorationSetsByExtension) {
  ...
  return DecorationSet3.create(doc, allDecorations);
}
...
var DecorationManager = class {
  ...
  createPlugin() {
    ...
    return new Plugin({
      ...
      props: {
        decorations(state) {
          var _a, _b;
          return (_b = (_a = DECORATION_MANAGER_PLUGIN_KEY.getState(state)) == null ? void 0 : _a.mergedDecorationSet) != null ? _b : DecorationSet4.empty;
        }
      }
    });
  }
  ...
  rebuildRanges(name, spec, previous, tr, newState, ranges) {
    var _a, _b;
    const previousSet = (_a = previous.decorationSetsByExtension[name]) != null ? _a : DecorationSet4.empty;
    const widgetKeys = new Set((_b = previous.widgetKeysByExtension[name]) != null ? _b : []);
...
var ClipboardTextSerializer = Extension.create({
  ...
  addProseMirrorPlugins() {
    return [
      new Plugin4({
        key: new PluginKey2("clipboardTextSerializer"),
        props: {
...
var focusEventsPluginKey = new PluginKey5("focusEvents");
...
import { Plugin as Plugin8, PluginKey as PluginKey6, Selection as Selection3 } from "@tiptap/pm/state";
var Keymap = Extension.create({
  ...
  addProseMirrorPlugins() {
    return [
      ...
      new Plugin8({
        key: new PluginKey6("clearDocument"),
...
var Paste = Extension.create({
  ...
  addProseMirrorPlugins() {
    return [
      new Plugin9({
        key: new PluginKey7("tiptapPaste"),
        props: {
...
var TextDirection = Extension.create({
  ...
  addProseMirrorPlugins() {
    return [
      new Plugin11({
        key: new PluginKey9("textDirection"),
        props: {
          attributes: () => {
...
import { Fragment as Fragment6 } from "@tiptap/pm/model";
import { ReplaceStep as ReplaceStep2 } from "@tiptap/pm/transform";
...
function warnOnDuplicatedProseMirrorModel(schema) {
  ...
  let content;
  try {
    content = ReplaceStep2.fromJSON(schema, { from: 0, to: 0 }).slice.content;
  } catch {
    return;
  }
  if (content instanceof Fragment6) {
    return;
  }
  console.warn(
